...
Settings_Vtiger_Edit_Js("Settings_ITS4YouProcessFlow_Edit_Js", {}, {
    ...
    registerEventForShowModuleFilterCondition: function () {
        ...
        jQuery('#module_name').on('change', function (e) {
            ...
            app.request.get({data: params}).then(function (error, data) {
                ...
                jQuery('#pf_condition').html(data);
                var advanceFilterContainer = jQuery('#advanceFilterContainer');
                vtUtils.applyFieldElementsView(jQuery('#pf_condition'));
                thisInstance.advanceFilterInstance = ITS4YouProcessFlow_AdvanceFilter_Js.getInstance(jQuery('.filterContainer', advanceFilterContainer));
    ...
    registerEvents: function () {
        ...
        this.registerEventForChangeITS4YouProcessFlowtate();
    }
});
