                        ...
                        <div class="summaryView">
                            <div class="summaryViewHeader">
                                ...
                                <div class="pull-right">
                                    ...
                                    {else}
                                        <button type="button" class="btn btn-default editProcessFlow"
                                                data-url="index.php?module=ITS4YouProcessFlow&parent=Settings&view=Edit&record={$RECORD_MODEL->getId()}">
                                ...
                                <div class="recordDetails">
                                    <table class="summary-table no-border">
                                        ...
                                        {if $RECORD_MODEL->getId() neq "0"}
                                            <tr class="summaryViewEntries">
                                                <td class="fieldLabel"><label
                                                            class="muted textOverflowEllipsis">{vtranslate('LBL_PROCESSFLOW_NAME', $QUALIFIED_MODULE)}</label>
                                                </td>
                                                <td class="fieldValue">{$RECORD_MODEL->get('name')}</td>
                                            </tr>
                                            <tr class="summaryViewEntries">
                                                <td class="fieldLabel"><label
                                                            class="muted textOverflowEllipsis">{vtranslate('LBL_DESCRIPTION',$QUALIFIED_MODULE)}</label>
                                                </td>
                                                <td class="fieldValue"
                                                    valign=top>{$RECORD_MODEL->get('description')}</td>
                                            </tr>
                                        {/if}
                                        <tr class="summaryViewEntries">
                                            <td class="fieldLabel"><label
                                        ...
                                        {if $RECORD_MODEL->getId() neq "0"}
                                            <tr class="summaryViewEntries">
                                                <td class="fieldLabel"><label
                                                            class="muted textOverflowEllipsis">{vtranslate('Status')}</label>
                                                </td>
                                                <td class="fieldValue"
                                                    valign=top> {if $RECORD_MODEL->get('status') eq '1'}{vtranslate('Active', $QUALIFIED_MODULE)}{else}{vtranslate('InActive', $QUALIFIED_MODULE)}{/if}</td>
                                            </tr>
                                        {/if}
                                        </tbody>
                                    </table>
                                                            ...
                                                            <tr class="listViewEntries" data-id="{$action_data.id}" data-recordUrl="{$action_data.detail_link}&pfid={$RECORD_MODEL->getId()}">
                                                                <td style="width:80px">
                                                                    ...
                                                                    <span class="actionImages">
                                                                        <a href="#" class="deleteRelatedAction" style="padding: 0 5px;" data-deleteurl="{$action_data.delete_link}">
                                                                ...
                                                                <td class="listViewEntryValue textOverflowEllipsis " width="%" nowrap>
                                                                    <a href="{$action_data.detail_link}&pfid={$RECORD_MODEL->getId()}">{$action_data.name}</a>
                                                                </td>
