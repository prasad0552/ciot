                            ...
                            <div class="list-group" id="{if $GROUP_LABEL eq 'Mine'}myList{else}sharedList{/if}">
                                ...
                                <ul class="lists-menu">
                                    ...
                                    {foreach item="CUSTOM_VIEW" from=$GROUP_CUSTOM_VIEWS name="customView"}
                                        ...
                                        <li style="font-size:12px;"
                                            class='listViewFilter {if $VIEWID eq $CUSTOM_VIEW->getId() && ($CURRENT_TAG eq '')} active {if $smarty.foreach.customView.iteration gt 10} {assign var=count value=1} {/if} {else if $smarty.foreach.customView.iteration gt 10} filterHidden hide{/if} '>
                                ...
                                <div class='clearfix'>
                                    ...
                                    <a class="toggleFilterSize"
                                       data-more-text=" {$smarty.foreach.customView.iteration - 10 - $count} {vtranslate('LBL_MORE',Vtiger)|@strtolower}"
                        ...
                        <div id="filterActionPopoverHtml">
                            <ul class="listmenu hide" role="menu">
                                ...
                                <li role="presentation" class="duplicateFilter">
                                    <a role="menuitem"><i
                                                class="fa fa-files-o"></i>&nbsp;{vtranslate('LBL_DUPLICATE',$MODULE)}
                                    </a>
                                </li>
                            ...
                            {foreach from=$EXTENSION_LINKS item=LINK}
                                {if $LINK->isExtensionAccessible()}
                                    <li style="font-size:12px;"
                                        ...
                                        <a href="{$LINK->get('linkurl')}">{vtranslate($LINK->get('linklabel'), $MODULE)}</a>
                                    </li>
                                {/if}
                            {/foreach}
                        </ul>
