...
Vtiger_Index_Js("Vtiger_Edit_Js", {
     ...
     * for a module if exist on change of picklist value
     */
    registerEventForFieldDependencySetup: function (container) {
        var fieldDependencyElemnt = jQuery('[name="fieldDependency"]', container);
        ...
        sourcePickListElements.on('change', function (e) {
            ...
            jQuery.each(picklistmap, function (targetFieldName, targetPickListValues) {
                var targetBlock = jQuery('*[data-block="' + targetFieldName + '"]', container);
    ...
    registerBasicEvents: function (form) {
        ...
        this.registerEventForFieldDependencySetup(form);
