            ...
            <div>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>{vtranslate('LBL_VERSION', $QUALIFIED_MODULE)}</th>
                                        ...
                                        <span class="extension_container">
                                            ...
                                            <span class="pull-right">
                                                ...
                                                {if $ALL_LANGUAGES[$LANG_KEY] neq ""}
                                                    <span class="alert alert-info" style="height: 10px;">{vtranslate('LBL_INSTALLED', $QUALIFIED_MODULE)}</span>
                                                {else}
                                                    <button class="oneclickInstallFree btn btn-success {if $IS_AUTH}authenticated {else} loginRequired{/if}">{vtranslate('LBL_INSTALL', $QUALIFIED_MODULE)}</button>
                                                {/if}
                                            </span>
                                        </span>
                                    </td>
