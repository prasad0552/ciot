                        ...
                        <div class="extension_container extensionWidgetContainer">
                            ...
                            <div class="" >
                                ...
                                <div class="col-md-12" style="text-align: right">
                                    ...
                                    {else}
                                        <span class="alert alert-error margin0px displayInlineBlock">{vtranslate('LBL_EXTENSION_NOT_COMPATABLE', $QUALIFIED_MODULE)}</span>
                                    {/if}
                                </div>
                            </div>
                        </div>
