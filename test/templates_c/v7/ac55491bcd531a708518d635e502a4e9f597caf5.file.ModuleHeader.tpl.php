<?php /* Smarty version Smarty-3.1.7, created on 2020-09-21 02:03:33
         compiled from "/var/www/html/ciot/includes/runtime/../../layouts/v7/modules/Settings/ITS4YouProcessFlow/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19312720585f6809f542f805-76523553%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ac55491bcd531a708518d635e502a4e9f597caf5' => 
    array (
      0 => '/var/www/html/ciot/includes/runtime/../../layouts/v7/modules/Settings/ITS4YouProcessFlow/ModuleHeader.tpl',
      1 => 1600651998,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19312720585f6809f542f805-76523553',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f6809f54953d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f6809f54953d')) {function content_5f6809f54953d($_smarty_tpl) {?>
...
<?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['SITEROAD']->value!=''){?><?php echo $_smarty_tpl->tpl_vars['SITEROAD']->value;?>
<?php }else{ ?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['PAGETITLE']->value;?>
<?php $_tmp2=ob_get_clean();?><?php echo vtranslate($_tmp2,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
<?php }?><?php }?><?php }?></span><?php }else{ ?><?php if ($_REQUEST['view']=='TaxIndex'){?><?php $_smarty_tpl->tpl_vars['SELECTED_MODULE'] = new Smarty_variable('LBL_TAX_MANAGEMENT', null, 0);?><?php }elseif($_REQUEST['view']=='TermsAndConditionsEdit'){?><?php $_smarty_tpl->tpl_vars['SELECTED_MODULE'] = new Smarty_variable('LBL_TERMS_AND_CONDITIONS', null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['SELECTED_MODULE'] = new Smarty_variable($_smarty_tpl->tpl_vars['ACTIVE_BLOCK']->value['menu'], null, 0);?><?php }?><span class="current-filter-name filter-name pull-left" style='width:50%;'><span class="display-inline-block"><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['PAGETITLE']->value;?>
