...
class Project extends CRMEntity
{
    ...
    function saveentity($module, $fileid = '')
    {
        ...
        if (empty($this->column_fields['projectstatus'])) {
            $this->column_fields['projectstatus'] = 'Requested';
        }

        if (empty($this->column_fields['cf_874'])) {
            $this->column_fields['cf_874'] = $current_user->id;
        }
