...
/**
 * Vtiger Create View Record Structure Model
 */
class Vtiger_CreateRecordStructure_Model extends Vtiger_RecordStructure_Model
{
    ...
    public function getStructure()
    {
        ...
        foreach ($blockModelList as $blockLabel => $blockModel) {
            /**
             * @var $blockModel Vtiger_Block_Model
             */
            ...
            if (!empty ($fieldModelList)) {
                ...
                foreach ($fieldModelList as $fieldName => $fieldModel) {
                    ...
                    if ($this->getModule()->getName() == 'Users') {
                        ...
                        $condition = $fieldModel->isViewableInCreateView();
                    }
