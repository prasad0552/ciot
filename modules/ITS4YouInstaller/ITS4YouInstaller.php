...
class ITS4YouInstaller {
    ...
    var $LBL_SETTINGS_NAME ='ITS4YouInstaller';
    var $LBL_MODULE_NAME = 'ITS4YouInstaller';
	var $db;
	var $log;
	var $moduleInstance;
	var $moduleName = 'ITS4YouInstaller';
	var $layout;
    ...
    public function updateSettings($enabled = true) {
	    ...
	    $this->db->pquery('ALTER TABLE its4you_installer_user ADD userid INT NOT NULL FIRST');
    }
